...
{/* 2. Using isJobAlreadyApplied here */}
            {!isJobAlreadyApplied ? (
              <button
                onClick={handleApply}
                className="bg-blue-600 text-white px-10 py-3 rounded-xl font-semibold text-lg
                hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all active:scale-95">
...
{/* 3. Also updated the sidebar button here */}
            <button 
              ...
              ${isJobAlreadyApplied ? 'bg-blue-400 cursor-not-allowed opacity-80' : 'bg-white text-blue-600 hover:bg-gray-100'}`}>
